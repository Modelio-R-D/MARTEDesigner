...
public class MARTEModelComponentContributor extends AbstractModelComponentContributor {
    ...
    public Set<TagType> getTagTypes() {
        Set<TagType> tagTypes = new HashSet<>();
               ...
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_BLOCKT));
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_PACKETT));
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_CAPACITY));
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_SPEEDFACTOR));
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_MAINSCHEDULER));
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_ELEMENTSIZE));
               tagTypes.add(getTagType(MARTEDesignerStereotypes.SWCOMMUNICATIONRESOURCE_LIFELINE, LoopNode.class, MARTEDesignerTagTypes.SWCOMMUNICATIONRESOURCE_LIFELINE_SWCOMMUNICATIONRESOURCE_LIFELINE_TRANSMMODE));
