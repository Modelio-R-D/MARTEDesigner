...
@objid ("fd35b473-32bd-4e75-8edd-60a1c6bb4330")
public class SwResource_AssociationProperty implements IPropertyContent {
    @objid ("e184405e-a717-4ec6-acb2-505c4b1cf8a6")
    private static List<ModelElement> typedElement = null;

    @objid ("7a2f314e-1e7e-4392-9adc-b2b891e15900")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("b5284e0a-d8e1-401e-84ad-25996a1ee6f9")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_IDENTIFIERELEMENTS, 
                    value);
        }
        else if(row == 2){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_STATEELEMENTS, 
                    value);
        }
        else if(row == 3){
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_MEMORYSIZEFOOTPRINT, 
                    value);
        }
        else if(row == 4){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_CREATESERVICES, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_DELETESERVICES, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_INITIALIZESERVICES, 
                    value);
        }
    }

    @objid ("ed46f290-955b-430e-8433-c666ca1e40c4")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_IDENTIFIERELEMENTS),value_identifierElements, tab_identifierElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_STATEELEMENTS),value_stateElements, tab_stateElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_MEMORYSIZEFOOTPRINT), value_memorySizeFootprint, tab_memorySizeFootprint);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_CREATESERVICES),value_createServices, tab_createServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_DELETESERVICES),value_deleteServices, tab_deleteServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATION_SWRESOURCE_ASSOCIATION_INITIALIZESERVICES),value_initializeServices, tab_initializeServices);
    }
