...
public class MutualExclusionResource_AssociationEndProperty implements IPropertyContent {
    ...
    @objid ("e32bbe1c-e1f8-4bd6-b2ad-5fe3acbfde0f")
    @Override
