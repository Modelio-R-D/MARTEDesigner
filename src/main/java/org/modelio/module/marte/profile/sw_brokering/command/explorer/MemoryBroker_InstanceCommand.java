...
@objid ("668cfe2b-23b2-4c7e-98dc-3fbec3a3dab2")
public class MemoryBroker_InstanceCommand extends DefaultModuleCommandHandler {
    @objid ("ba29be52-9aa6-4275-8970-743afcfdf7cb")
    @Override
    ...
    @objid ("01d5661a-01b0-4e6d-8ff1-ba2adc7add7c")
    @Override
    public void actionPerformed(List<MObject> selected_element, IModule module) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("MemoryBroker_InstanceCommand")){
