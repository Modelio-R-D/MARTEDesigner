...
@objid ("45a6f24d-0c52-437d-b084-d146493f0cfa")
public class SwSchedulableResource_AttributeProperty implements IPropertyContent {
    @objid ("83f42153-a6b1-46f1-950b-66be7fb4f4e5")
    private static List<ModelElement> typedElement = null;

    @objid ("a77e3fcd-21b8-4c22-a1b5-3c95a7822c41")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("6c146bae-6d68-44c9-b2c2-15e062b149b9")
    private static List<ModelElement> namedElement = null;

    @objid ("054e2871-4cb8-4db2-8422-a70addb2e7b4")
    private static List<ModelElement> listScheduler = null;

    @objid ("27d081dc-a09a-4d5d-a5bb-ab356fd163e1")
    private static List<ModelElement> listSecondaryScheduler = null;

    @objid ("f7080fb0-4f80-47de-a16e-48e56925acd8")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_ISSTATICSCHEDULINGFEATURE, value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_ISPREEMPTABLE, value);
        }
        else if(row == 3){
            ModelUtils.manageSingleOrientedLink(elt, 
                    namedElement, 
                    MARTEDesignerStereotypes.PROFILEASSOCIATION_SCHEDULERS_SWSCHEDULABLERESOURCE, 
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_SCHEDULERS, 
                    value);
        }
        else if(row == 4){
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DEADLINEELEMENTS, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DEADLINETYPEELEMENTS, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_TIMESLICEELEMENTS, 
                    value);
        }
        else if(row == 7){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DELAYSERVICES, 
                    value);
        }
        else if(row == 8){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_JOINSERVICES, 
                    value);
        }
        else if(row == 9){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_YIELDSERVICES, 
                    value);
        }    
        else if(row == 10){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_SCHEDPARAMS, value);
        }
        else if(row == 11){
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_HOST,
                    possibleTagTypeName,
                    value
            );
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DEPENDENTSCHEDULER,
                    possibleTagTypeName,
                    value
            );
        }
    ...
    @objid ("394fc8df-3c07-4852-9d2e-841393f7281e")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_ISSTATICSCHEDULINGFEATURE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_ISSTATICSCHEDULINGFEATURE, elt));
        
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_ISPREEMPTABLE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_ISPREEMPTABLE, elt));
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_SCHEDULERS), value_schedulers, tab_schedulers);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DEADLINEELEMENTS),value_deadlineElements, tab_deadlineElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DEADLINETYPEELEMENTS),value_deadlineTypeElements, tab_deadlineTypeElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_TIMESLICEELEMENTS),value_timeSliceElements, tab_timeSliceElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DELAYSERVICES),value_delayServices, tab_delayServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_JOINSERVICES),value_joinServices, tab_joinServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_YIELDSERVICES),value_yieldServices, tab_yieldServices);
        
        String value_schedParams = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_SCHEDPARAMS, elt);
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_SCHEDPARAMS),value_schedParams);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_HOST), value_host, tab_host);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ATTRIBUTE_SWSCHEDULABLERESOURCE_ATTRIBUTE_DEPENDENTSCHEDULER), value_dependentScheduler, tab_dependentScheduler);
    }
