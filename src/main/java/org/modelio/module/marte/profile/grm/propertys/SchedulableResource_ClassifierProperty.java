...
@objid ("b3688701-aef2-435c-aa87-c7a066c2e1cd")
public class SchedulableResource_ClassifierProperty implements IPropertyContent {
    @objid ("98574cfe-c236-42cb-a8e1-51670f9a5213")
    private static List<ModelElement> listScheduler = null;

    @objid ("f2b3485a-c33a-45fc-8f4e-2d080d38ffa0")
    private static List<ModelElement> listSecondaryScheduler = null;

    @objid ("82ece1c0-c115-432a-9ad7-101ae1d0d8a6")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_SCHEDPARAMS, value);
        }
        else if(row == 2){
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_HOST,
                    possibleTagTypeName,
                    value
            );
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_DEPENDENTSCHEDULER,
                    possibleTagTypeName,
                    value
            );
        }
    ...
    @objid ("9a87e7af-605f-4b88-911b-21e5f82c5a21")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        //
        // Schedulable Resource
        //
        String value_schedParams = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_SCHEDPARAMS, elt);
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_SCHEDPARAMS),value_schedParams);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_HOST), value_host, tab_host);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULABLERESOURCE_CLASSIFIER_SCHEDULABLERESOURCE_CLASSIFIER_DEPENDENTSCHEDULER), value_dependentScheduler, tab_dependentScheduler);
    }
