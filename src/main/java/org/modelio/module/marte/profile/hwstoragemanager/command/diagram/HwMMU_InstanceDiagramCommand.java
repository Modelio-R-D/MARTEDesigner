...
@objid ("f3928e92-abe7-4e78-8cbc-80b7e07fb8b2")
public class HwMMU_InstanceDiagramCommand extends DefaultBoxTool {
    @objid ("3296770c-be60-46ca-8d28-7ce468b387cd")
    @Override
    ...
    @objid ("b65c9283-6fc9-47a6-b421-b57e1a29b087")
    @Override
