...
@objid ("dd8adeb9-11b8-4151-89a0-3d6471cec599")
public class MemoryPartition_InstanceProperty implements IPropertyContent {
    @objid ("e82e3605-6ea1-45ad-b91f-09dc5eeaf6cf")
    private static List<ModelElement> typedElement = null;

    @objid ("40adf37a-68eb-42db-b42c-45233aff190b")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("fe2a9995-6031-4374-994e-db45b7f5d557")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        ...
        //                    MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_CONCURRENTRESOURCES, 
                    value);
        ...
        //                    MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_MEMORYSPACES, 
                    value);
        }
        else if(row == 3){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_FORK, 
                    value);
        }
        else if(row == 4){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_EXIT, 
                    value);
        }
    }

    @objid ("36027cb2-6578-4433-80e9-150ae0363812")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_CONCURRENTRESOURCES),value_concurrentResources, tab_concurrentResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_MEMORYSPACES),value_memorySpaces, tab_memorySpaces);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_FORK),value_fork, tab_fork);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.MEMORYPARTITION_INSTANCE_MEMORYPARTITION_INSTANCE_EXIT), value_exit, tab_exit);
    }
