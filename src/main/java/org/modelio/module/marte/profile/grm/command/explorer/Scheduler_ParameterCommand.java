...
@objid ("f81b11a3-e474-4f1f-a1d5-c1fa14bfe172")
public class Scheduler_ParameterCommand extends DefaultModuleCommandHandler {
    @objid ("0a63211a-41c0-4a14-a552-61b6ade5254f")
    @Override
    ...
    @objid ("b32cfcd7-ec6b-4576-9f12-130c1657bc0d")
    @Override
    public void actionPerformed(List<MObject> selected_element, IModule module) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("Scheduler_ParameterCommand")){
            ...
            Scheduler_Parameter proxy = new Scheduler_Parameter();
