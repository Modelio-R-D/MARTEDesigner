...
@objid ("13bada1f-d01a-40d1-8faf-cabf9e03f2db")
public class HwBridge_NodeDiagramCommand extends DefaultBoxTool {
    @objid ("cd08bc5f-dbf5-41a6-ba4a-2b95fd1ad4b6")
    @Override
    ...
    @objid ("a2ca2f10-b5cd-46f5-a360-b221c116cee7")
    @Override
