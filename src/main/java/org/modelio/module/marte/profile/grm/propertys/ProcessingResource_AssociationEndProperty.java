...
@objid ("1da6b869-3da5-4ef9-b934-bb1b797c6bfe")
public class ProcessingResource_AssociationEndProperty implements IPropertyContent {
    @objid ("12e4cc49-d7ef-44c2-83d1-9a06a2746a2f")
    private static List<ModelElement> listScheduler = null;

    @objid ("6fb3057b-b7c8-4597-a421-ec17fca59004")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.PROCESSINGRESOURCE_ASSOCIATIONEND_PROCESSINGRESOURCE_ASSOCIATIONEND_MAINSCHEDULER, 
                    possibleTagTypeName,
                    value
            );
            ...
            if (ModelUtils.isDouble(value)) {
                ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.PROCESSINGRESOURCE_ASSOCIATIONEND_PROCESSINGRESOURCE_ASSOCIATIONEND_SPEEDFACTOR, value);
            }else{
    ...
    @objid ("0f8bfc59-d506-460b-9820-bafef919de8a")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.PROCESSINGRESOURCE_ASSOCIATIONEND_PROCESSINGRESOURCE_ASSOCIATIONEND_MAINSCHEDULER), value_mainScheduler, tab_mainScheduler);
        
        String value_speedFactor = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.PROCESSINGRESOURCE_ASSOCIATIONEND_PROCESSINGRESOURCE_ASSOCIATIONEND_SPEEDFACTOR, elt);
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.PROCESSINGRESOURCE_ASSOCIATIONEND_PROCESSINGRESOURCE_ASSOCIATIONEND_SPEEDFACTOR),value_speedFactor);
    }
