...
@objid ("5bbc12a5-e37a-4691-aab9-afa3cc1e76a0")
public class HwDMA_InstanceDiagramCommand extends DefaultBoxTool {
    @objid ("09a935a8-8160-48fc-8193-e21a520b5bb3")
    @Override
    ...
    @objid ("5729399b-bce3-416d-b5ef-a966ec6ea614")
    @Override
