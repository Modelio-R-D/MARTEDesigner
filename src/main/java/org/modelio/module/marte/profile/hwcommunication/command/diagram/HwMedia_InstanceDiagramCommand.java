...
@objid ("53d35bf5-f5fd-42bf-a177-dcc8e4d46227")
public class HwMedia_InstanceDiagramCommand extends DefaultBoxTool {
    @objid ("fc5a46d9-3425-4db4-b1bd-514bde75a686")
    @Override
    ...
    @objid ("3867e0be-5744-4058-a206-e287b2c5e823")
    @Override
