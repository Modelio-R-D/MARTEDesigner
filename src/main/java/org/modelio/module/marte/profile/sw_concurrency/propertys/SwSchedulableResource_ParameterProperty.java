...
@objid ("799e74dd-7df5-4a4f-827b-76705d1a50ae")
public class SwSchedulableResource_ParameterProperty implements IPropertyContent {
    @objid ("3abf07d5-0ef3-41f6-97ca-2189b0883c17")
    private static List<ModelElement> typedElement = null;

    @objid ("b03ef293-6143-4b88-bdf9-d3a53a71a0c2")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("f2c62cfd-9a32-4a1e-9fa7-a8f403eaf4ff")
    private static List<ModelElement> namedElement = null;

    @objid ("bc51639f-6cf9-4ce4-9728-e09aaa132c3b")
    private static List<ModelElement> listScheduler = null;

    @objid ("c4c1df52-6566-41f9-8824-377a938acaf7")
    private static List<ModelElement> listSecondaryScheduler = null;

    @objid ("16f655c6-af1f-4486-a026-4e2a65507b1c")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_ISSTATICSCHEDULINGFEATURE, value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_ISPREEMPTABLE, value);
        }
        else if(row == 3){
            ModelUtils.manageSingleOrientedLink(elt, 
                    namedElement, 
                    MARTEDesignerStereotypes.PROFILEASSOCIATION_SCHEDULERS_SWSCHEDULABLERESOURCE, 
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_SCHEDULERS, 
                    value);
        }
        else if(row == 4){
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DEADLINEELEMENTS, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DEADLINETYPEELEMENTS, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_TIMESLICEELEMENTS, 
                    value);
        }
        else if(row == 7){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DELAYSERVICES, 
                    value);
        }
        else if(row == 8){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_JOINSERVICES, 
                    value);
        }
        else if(row == 9){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_YIELDSERVICES, 
                    value);
        }    
        else if(row == 10){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_SCHEDPARAMS, value);
        }
        else if(row == 11){
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_HOST,
                    possibleTagTypeName,
                    value
            );
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DEPENDENTSCHEDULER,
                    possibleTagTypeName,
                    value
            );
        }
    ...
    @objid ("31786513-0c78-48db-a4e0-3789edac3d08")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_ISSTATICSCHEDULINGFEATURE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_ISSTATICSCHEDULINGFEATURE, elt));
        
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_ISPREEMPTABLE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_ISPREEMPTABLE, elt));
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_SCHEDULERS), value_schedulers, tab_schedulers);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DEADLINEELEMENTS),value_deadlineElements, tab_deadlineElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DEADLINETYPEELEMENTS),value_deadlineTypeElements, tab_deadlineTypeElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_TIMESLICEELEMENTS),value_timeSliceElements, tab_timeSliceElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DELAYSERVICES),value_delayServices, tab_delayServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_JOINSERVICES),value_joinServices, tab_joinServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_YIELDSERVICES),value_yieldServices, tab_yieldServices);
        
        String value_schedParams = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_SCHEDPARAMS, elt);
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_SCHEDPARAMS),value_schedParams);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_HOST), value_host, tab_host);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_PARAMETER_SWSCHEDULABLERESOURCE_PARAMETER_DEPENDENTSCHEDULER), value_dependentScheduler, tab_dependentScheduler);
    }
