...
@objid ("6a6bda14-7740-47f1-8fb6-7f51b77c25ba")
public class HwBranchPredictor_InstanceDiagramCommand extends DefaultBoxTool {
    @objid ("8f789ff7-bfaa-4bba-bed9-cdddb18bcc5a")
    @Override
    ...
    @objid ("95abf3d9-d171-4e60-8c91-9282e76c0b7f")
    @Override
    public void actionPerformed(final IDiagramHandle diagramHandle, IDiagramGraphic targetNode, Rectangle rec) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("HwBranchPredictor_InstanceCommand")){
