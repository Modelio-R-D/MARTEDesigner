...
@objid ("5318331a-99f7-49d6-9e86-b59caecf2442")
public class SecondaryScheduler_LinkProperty implements IPropertyContent {
    @objid ("7466a422-c095-4b41-a98d-e46d43116cf7")
    private static List<ModelElement> listSchedulableResource = null;

    @objid ("a701c305-a939-440d-9e96-3c66591160a1")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ...
            ModelUtils.manageMultipleToOneLink(elt,
                    ...
                    possibleTagTypeName,
                    MARTEDesignerTagTypes.SECONDARYSCHEDULER_LINK_SECONDARYSCHEDULER_LINK_VIRTUALPROCESSINGUNITS,
                    value
            );
        }
    }

    @objid ("5dbdc0a8-acaa-4a1c-8612-7106ced04829")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SECONDARYSCHEDULER_LINK_SECONDARYSCHEDULER_LINK_VIRTUALPROCESSINGUNITS), value_virtualProcessingUnits, tab_virtualProcessingUnits);
    }
