...
@objid ("1a08df1f-47fd-4b5c-bc09-98cd87f40a56")
public class HwMedia_AssociationEndProperty implements IPropertyContent {
    @objid ("0f218019-de2f-41bf-9648-88ab98d36736")
    private static List<String> tagTypeNames = new ArrayList<>();

    @objid ("21941f5b-6a0b-4c2e-bc91-f180668c65cc")
    private static List<ModelElement> hwArbiter;

    @objid ("f69ba397-667f-47d6-ba64-6a48774eb65d")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.manageSourceMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.HWMEDIA_ASSOCIATIONEND_HWMEDIA_ASSOCIATIONEND_ARBITERS,
                    tagTypeNames,
                    value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.HWMEDIA_ASSOCIATIONEND_HWMEDIA_ASSOCIATIONEND_BANDWIDTH, value);
        }
    }

    @objid ("f6445e26-5eb8-4862-92b5-55dc34b61c27")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.HWMEDIA_ASSOCIATIONEND_HWMEDIA_ASSOCIATIONEND_ARBITERS),value_arbiters, tabArbiters);
        
        String value_bandwidth = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.HWMEDIA_ASSOCIATIONEND_HWMEDIA_ASSOCIATIONEND_BANDWIDTH, elt);
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.HWMEDIA_ASSOCIATIONEND_HWMEDIA_ASSOCIATIONEND_BANDWIDTH),value_bandwidth);
    }
