...
@objid ("3ff59244-6ae6-4760-8742-3b4d23609239")
public class SecondaryScheduler_AttributeProperty implements IPropertyContent {
    @objid ("cb46916a-07f3-4210-be0f-5658aed9424d")
    private static List<ModelElement> listSchedulableResource = null;

    @objid ("4558a653-78c7-495a-a263-552903484e7d")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ...
            ModelUtils.manageMultipleToOneLink(elt,
                    ...
                    possibleTagTypeName,
                    MARTEDesignerTagTypes.SECONDARYSCHEDULER_ATTRIBUTE_SECONDARYSCHEDULER_ATTRIBUTE_VIRTUALPROCESSINGUNITS,
                    value
            );
        }
    }

    @objid ("63ae6315-5c27-4a10-9c0e-2da3cdbd135b")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SECONDARYSCHEDULER_ATTRIBUTE_SECONDARYSCHEDULER_ATTRIBUTE_VIRTUALPROCESSINGUNITS), value_virtualProcessingUnits, tab_virtualProcessingUnits);
    }
