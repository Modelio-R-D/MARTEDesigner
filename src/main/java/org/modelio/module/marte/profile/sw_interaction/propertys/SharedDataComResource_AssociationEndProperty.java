...
public class SharedDataComResource_AssociationEndProperty implements IPropertyContent {
    ...
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        ...
        //                    MARTEDesignerTagTypes.SHAREDDATACOMRESOURCE_ASSOCIATIONEND_SHAREDDATACOMRESOURCE_ASSOCIATIONEND_READSERVICES, 
                    value);
        }
        else if(row == 2){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SHAREDDATACOMRESOURCE_ASSOCIATIONEND_SHAREDDATACOMRESOURCE_ASSOCIATIONEND_WRITESERVICES, 
                    value);
        }
    }
    ...
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SHAREDDATACOMRESOURCE_ASSOCIATIONEND_SHAREDDATACOMRESOURCE_ASSOCIATIONEND_READSERVICES),value_readServices, tab_readServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SHAREDDATACOMRESOURCE_ASSOCIATIONEND_SHAREDDATACOMRESOURCE_ASSOCIATIONEND_WRITESERVICES),value_writeServices, tab_writeServices);
    }
