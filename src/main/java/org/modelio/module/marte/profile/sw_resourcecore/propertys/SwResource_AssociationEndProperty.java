...
@objid ("9c8d1ff2-c380-4c6d-a1e2-f367b0f9ae33")
public class SwResource_AssociationEndProperty implements IPropertyContent {
    @objid ("7384bd6e-b57a-4b0c-881a-ec9da602acf9")
    private static List<ModelElement> typedElement = null;

    @objid ("9c81392c-55e4-407e-87eb-b6fbbc735965")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("206886fc-e8a4-4569-b81d-55fc476e65e1")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_IDENTIFIERELEMENTS, 
                    value);
        }
        else if(row == 2){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_STATEELEMENTS, 
                    value);
        }
        else if(row == 3){
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_MEMORYSIZEFOOTPRINT, 
                    value);
        }
        else if(row == 4){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_CREATESERVICES, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_DELETESERVICES, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_INITIALIZESERVICES, 
                    value);
        }
    }

    @objid ("c5c1010b-7f2f-4f6d-9ec0-55775732368b")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_IDENTIFIERELEMENTS),value_identifierElements, tab_identifierElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_STATEELEMENTS),value_stateElements, tab_stateElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_MEMORYSIZEFOOTPRINT), value_memorySizeFootprint, tab_memorySizeFootprint);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_CREATESERVICES),value_createServices, tab_createServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_DELETESERVICES),value_deleteServices, tab_deleteServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_ASSOCIATIONEND_SWRESOURCE_ASSOCIATIONEND_INITIALIZESERVICES),value_initializeServices, tab_initializeServices);
    }
