...
@objid ("2d289ce2-8714-4898-bf72-66138d698f73")
public class SwConcurrentResource_LinkProperty implements IPropertyContent {
    @objid ("a3c336cd-3836-4726-acfc-c45e1f46f37f")
    private static List<ModelElement> typedElement = null;

    @objid ("376262e2-f156-4e8a-bb46-6aebb6909572")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("cf7136f0-9f16-461b-a83b-8203c44d1305")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_TYPE, value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ACTIVATIONCAPACITY, value);
        }
        else if(row == 3){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ENTRYPOINTS, value);
        }
        else if(row == 4){
            ModelUtils.manageMultipleOrientedLink(elt, 
                    typedElement, 
                    MARTEDesignerStereotypes.PROFILEASSOCIATION_ADDRESSSPACE_SWCONCURRENTRESOURCE, 
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ADRESSSPACE, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_PERIODELEMENTS, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_PRIORITYELEMENTS, 
                    value);
        }
        else if(row == 7){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_STACKSIZEELEMENTS, 
                    value);
        }
        else if(row == 8){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ACTIVATESERVICES, 
                    value);
        }
        else if(row == 9){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ENABLECONCURRENCYSERVICES, 
                    value);
        }
        else if(row == 10){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_RESUMESERVICES, 
                    value);
        }
        else if(row == 11){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_SUSPENDSERVICES, 
                    value);
        }
        else if(row == 12){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_TERMINATESERVICES, 
                    value);
        }
        else if(row == 13){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_DISABLECONCURRENCYSERVICES, 
                    value);
        }
        else if(row == 14){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_SHAREDATARESOURCES, 
                    value);
        }
        else if(row == 15){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_MESSAGERESOURCES, 
                    value);
        }
        else if(row == 16){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_MUTUALEXCLUSIONRESOURCES, 
                    value);
        }
        else if(row == 17){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_NOTIFICATIONRESOURCES, 
                    value);
        }
        else if(row == 18){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_HEAPSIZEELEMENTS, 
                    value);
        }
    }

    @objid ("5a18b4d4-ce2a-4110-85f7-d248367977f1")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        String value_type = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_TYPE, elt);
        if(value_type.equals("")){
            value_type = "";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_TYPE),value_type);
        
        
        String value_activationCapacity = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ACTIVATIONCAPACITY, elt);
        if(value_activationCapacity.equals("")){
            value_activationCapacity = "";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ACTIVATIONCAPACITY),value_activationCapacity);
        
        
        String value_entryPoint = ModelUtils.getTargetDependencyNames(MARTEDesignerStereotypes.ENTRYPOINT_DEPENDENCY, elt);
        table.addConsultProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ENTRYPOINTS),
                value_entryPoint);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_PERIODELEMENTS),value_periodElements, tab_periodElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_PRIORITYELEMENTS),value_priorityElements, tab_priorityElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_STACKSIZEELEMENTS),value_stackSizeElements, tab_stackSizeElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ACTIVATESERVICES),value_activateServices, tab_activateServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_ENABLECONCURRENCYSERVICES),value_enableConcurrencyServices, tab_enableConcurrencyServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_RESUMESERVICES),value_resumeServices, tab_resumeServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_SUSPENDSERVICES),value_suspendServices, tab_suspendServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_TERMINATESERVICES),value_terminateServices, tab_terminateServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_DISABLECONCURRENCYSERVICES),value_disableConcurrencyServices, tab_disableConcurrencyServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_SHAREDATARESOURCES),value_shareDataResources, tab_shareDataResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_MESSAGERESOURCES),value_messageResources, tab_messageResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_MUTUALEXCLUSIONRESOURCES),value_mutualExclusionResources, tab_mutualExclusionResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_NOTIFICATIONRESOURCES),value_notificationResources, tab_notificationResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_LINK_SWCONCURRENTRESOURCE_LINK_HEAPSIZEELEMENTS),value_heapSizeElements, tab_heapSizeElements);
    }
