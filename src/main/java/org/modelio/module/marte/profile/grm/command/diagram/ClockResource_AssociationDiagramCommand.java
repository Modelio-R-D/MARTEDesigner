...
import org.modelio.module.marte.profile.grm.model.ClockResource_Association;

@objid ("66017667-8c3e-4813-9b9a-2fe2e02fe0d6")
public class ClockResource_AssociationDiagramCommand extends DefaultLinkTool {
    @objid ("b4f156ca-2bab-4769-9738-15e23d452d01")
    @Override
    ...
    @objid ("01f9d1fc-1de7-464f-8c1b-fc8212e51357")
    @Override
    ...
    @objid ("465f77b5-c172-4434-8a54-08eacb60c17d")
    @Override
    public void actionPerformed(final IDiagramHandle diagramHandle, IDiagramGraphic originNode, IDiagramGraphic targetNode, LinkRouterKind touterType, ILinkPath path) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("ClockResource_AssociationCommand")){
        
        
        
            ClockResource_Association proxy = new ClockResource_Association();
