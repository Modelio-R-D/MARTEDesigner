...
@objid ("362aa292-ae3b-455a-a7e6-66dddc28c69f")
public class HwASIC_InstanceDiagramCommand extends DefaultBoxTool {
    @objid ("029c016b-040c-4120-a3d0-69644b8c7c4d")
    @Override
    ...
    @objid ("4c77808f-f33d-4ae1-9d44-9ee74f7dd23c")
    @Override
    public void actionPerformed(final IDiagramHandle diagramHandle, IDiagramGraphic targetNode, Rectangle rec) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("HwASIC_InstanceCommand")){
