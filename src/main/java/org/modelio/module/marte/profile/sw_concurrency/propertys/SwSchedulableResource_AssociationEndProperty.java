...
@objid ("1d81cd0b-60a3-485a-ab2f-117a3896f664")
public class SwSchedulableResource_AssociationEndProperty implements IPropertyContent {
    @objid ("663a71fe-6538-4a61-92e5-d6fd9d40df16")
    private static List<ModelElement> typedElement = null;

    @objid ("0ae16b2b-41d5-4304-98cb-f320d9911424")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("f89d13e9-99dc-4bc5-ac51-21932cc84394")
    private static List<ModelElement> namedElement = null;

    @objid ("0633676a-f94c-4861-9e3c-199102133cdc")
    private static List<ModelElement> listScheduler = null;

    @objid ("79f5ce19-6927-4f39-b767-bc0e609d2d9a")
    private static List<ModelElement> listSecondaryScheduler = null;

    @objid ("9e2d70bb-fc9d-4fd9-84ff-15e135c0f59c")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_ISSTATICSCHEDULINGFEATURE, value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_ISPREEMPTABLE, value);
        }
        else if(row == 3){
            ModelUtils.manageSingleOrientedLink(elt, 
                    namedElement, 
                    MARTEDesignerStereotypes.PROFILEASSOCIATION_SCHEDULERS_SWSCHEDULABLERESOURCE, 
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SCHEDULERS, 
                    value);
        }
        else if(row == 4){
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DEADLINEELEMENTS, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DEADLINETYPEELEMENTS, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_TIMESLICEELEMENTS, 
                    value);
        }
        else if(row == 7){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DELAYSERVICES, 
                    value);
        }
        else if(row == 8){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_JOINSERVICES, 
                    value);
        }
        else if(row == 9){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_YIELDSERVICES, 
                    value);
        }    
        else if(row == 10){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SCHEDPARAMS, value);
        }
        else if(row == 11){
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_HOST,
                    possibleTagTypeName,
                    value
            );
            ...
            ModelUtils.manageOneToMultipleLink(elt, 
                    ...
                    MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DEPENDENTSCHEDULER,
                    possibleTagTypeName,
                    value
            );
        }
    ...
    @objid ("3d3ea500-a3f6-40dc-bd2b-fef9ec35bc68")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_ISSTATICSCHEDULINGFEATURE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_ISSTATICSCHEDULINGFEATURE, elt));
        
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_ISPREEMPTABLE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_ISPREEMPTABLE, elt));
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SCHEDULERS), value_schedulers, tab_schedulers);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DEADLINEELEMENTS),value_deadlineElements, tab_deadlineElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DEADLINETYPEELEMENTS),value_deadlineTypeElements, tab_deadlineTypeElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_TIMESLICEELEMENTS),value_timeSliceElements, tab_timeSliceElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DELAYSERVICES),value_delayServices, tab_delayServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_JOINSERVICES),value_joinServices, tab_joinServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_YIELDSERVICES),value_yieldServices, tab_yieldServices);
        
        String value_schedParams = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SCHEDPARAMS, elt);
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SCHEDPARAMS),value_schedParams);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_HOST), value_host, tab_host);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWSCHEDULABLERESOURCE_ASSOCIATIONEND_SWSCHEDULABLERESOURCE_ASSOCIATIONEND_DEPENDENTSCHEDULER), value_dependentScheduler, tab_dependentScheduler);
    }
