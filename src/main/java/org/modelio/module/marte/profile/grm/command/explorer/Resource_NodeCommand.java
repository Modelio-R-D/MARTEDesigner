...
public class Resource_NodeCommand extends DefaultModuleCommandHandler {
    @Override
    ...
    public void actionPerformed(List<MObject> selected_element, IModule module) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("Resource_NodeCommand")){
        
        
            ModelElement parent = (ModelElement)selected_element.get(0);        
            Resource_Node proxy = new Resource_Node();
