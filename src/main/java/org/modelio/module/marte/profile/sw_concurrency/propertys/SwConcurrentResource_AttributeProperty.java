...
@objid ("6b292809-1de7-4efb-86ff-80c0e8435cfb")
public class SwConcurrentResource_AttributeProperty implements IPropertyContent {
    @objid ("c59b55f2-f511-4d3a-a502-7017575fc3b7")
    private static List<ModelElement> typedElement = null;

    @objid ("8525c997-b54d-4f78-ab59-6ef1abd08442")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("aeffc7f8-7a0d-444d-af05-390f6e3d71b9")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_TYPE, value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ACTIVATIONCAPACITY, value);
        }
        else if(row == 3){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ENTRYPOINTS, value);
        }
        else if(row == 4){
            ModelUtils.manageMultipleOrientedLink(elt, 
                    typedElement, 
                    MARTEDesignerStereotypes.PROFILEASSOCIATION_ADDRESSSPACE_SWCONCURRENTRESOURCE, 
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ADRESSSPACE, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_PERIODELEMENTS, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_PRIORITYELEMENTS, 
                    value);
        }
        else if(row == 7){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_STACKSIZEELEMENTS, 
                    value);
        }
        else if(row == 8){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ACTIVATESERVICES, 
                    value);
        }
        else if(row == 9){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ENABLECONCURRENCYSERVICES, 
                    value);
        }
        else if(row == 10){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_RESUMESERVICES, 
                    value);
        }
        else if(row == 11){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_SUSPENDSERVICES, 
                    value);
        }
        else if(row == 12){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_TERMINATESERVICES, 
                    value);
        }
        else if(row == 13){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_DISABLECONCURRENCYSERVICES, 
                    value);
        }
        else if(row == 14){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_SHAREDATARESOURCES, 
                    value);
        }
        else if(row == 15){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_MESSAGERESOURCES, 
                    value);
        }
        else if(row == 16){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_MUTUALEXCLUSIONRESOURCES, 
                    value);
        }
        else if(row == 17){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_NOTIFICATIONRESOURCES, 
                    value);
        }
        else if(row == 18){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_HEAPSIZEELEMENTS, 
                    value);
        }
    }

    @objid ("9bd40ba4-e187-40f0-9d77-0a56e3a3ec93")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        String value_type = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_TYPE, elt);
        if(value_type.equals("")){
            value_type = "";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_TYPE),value_type);
        
        
        String value_activationCapacity = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ACTIVATIONCAPACITY, elt);
        if(value_activationCapacity.equals("")){
            value_activationCapacity = "";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ACTIVATIONCAPACITY),value_activationCapacity);
        
        
        String value_entryPoint = ModelUtils.getTargetDependencyNames(MARTEDesignerStereotypes.ENTRYPOINT_DEPENDENCY, elt);
        table.addConsultProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ENTRYPOINTS),
                value_entryPoint);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_PERIODELEMENTS),value_periodElements, tab_periodElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_PRIORITYELEMENTS),value_priorityElements, tab_priorityElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_STACKSIZEELEMENTS),value_stackSizeElements, tab_stackSizeElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ACTIVATESERVICES),value_activateServices, tab_activateServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_ENABLECONCURRENCYSERVICES),value_enableConcurrencyServices, tab_enableConcurrencyServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_RESUMESERVICES),value_resumeServices, tab_resumeServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_SUSPENDSERVICES),value_suspendServices, tab_suspendServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_TERMINATESERVICES),value_terminateServices, tab_terminateServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_DISABLECONCURRENCYSERVICES),value_disableConcurrencyServices, tab_disableConcurrencyServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_SHAREDATARESOURCES),value_shareDataResources, tab_shareDataResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_MESSAGERESOURCES),value_messageResources, tab_messageResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_MUTUALEXCLUSIONRESOURCES),value_mutualExclusionResources, tab_mutualExclusionResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_NOTIFICATIONRESOURCES),value_notificationResources, tab_notificationResources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWCONCURRENTRESOURCE_ATTRIBUTE_SWCONCURRENTRESOURCE_ATTRIBUTE_HEAPSIZEELEMENTS),value_heapSizeElements, tab_heapSizeElements);
    }
