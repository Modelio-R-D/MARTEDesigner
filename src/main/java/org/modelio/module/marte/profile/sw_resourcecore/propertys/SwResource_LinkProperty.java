...
@objid ("596a4735-11c6-452e-a755-214e605295c6")
public class SwResource_LinkProperty implements IPropertyContent {
    @objid ("328589cf-11f0-441d-a905-3c8b487468b9")
    private static List<ModelElement> typedElement = null;

    @objid ("ca564601-14e4-4d77-a045-b6bbf91fecd4")
    private static List<ModelElement> behavioralFeature = null;

    @objid ("a194b27e-ad02-4dfa-b99a-63fcea20b8fa")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_IDENTIFIERELEMENTS, 
                    value);
        }
        else if(row == 2){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_STATEELEMENTS, 
                    value);
        }
        else if(row == 3){
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_MEMORYSIZEFOOTPRINT, 
                    value);
        }
        else if(row == 4){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_CREATESERVICES, 
                    value);
        }
        else if(row == 5){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_DELETESERVICES, 
                    value);
        }
        else if(row == 6){
            ModelUtils.manageMultipleOrientedLink(elt, 
        ...
        //                    MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_INITIALIZESERVICES, 
                    value);
        }
    }

    @objid ("aa561f7b-9af7-478b-a04b-53c9473e32f4")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_IDENTIFIERELEMENTS),value_identifierElements, tab_identifierElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_STATEELEMENTS),value_stateElements, tab_stateElements);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_MEMORYSIZEFOOTPRINT), value_memorySizeFootprint, tab_memorySizeFootprint);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_CREATESERVICES),value_createServices, tab_createServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_DELETESERVICES),value_deleteServices, tab_deleteServices);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SWRESOURCE_LINK_SWRESOURCE_LINK_INITIALIZESERVICES),value_initializeServices, tab_initializeServices);
    }
