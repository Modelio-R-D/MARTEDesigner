...
@objid ("e0a65919-f131-4aa1-a1c2-f15f3bd242bd")
public class Scheduler_LifelineProperty implements IPropertyContent {
    @objid ("63dd0a62-0e72-4075-9b37-8eab75dde4e7")
    private static List<ModelElement> listComputingResource = null;

    @objid ("cc3e5d20-b04b-41a9-993b-098c2f0364b0")
    private static List<ModelElement> listMutualExclusionResource = null;

    @objid ("3035b941-1e3e-48f6-906e-8e408b3f3f16")
    private static List<ModelElement> listProcessingResource = null;

    @objid ("0cb604e4-9416-4747-9cb5-1d728822b4d9")
    private static List<ModelElement> listSchedulableResource = null;

    @objid ("8d6ad55a-c930-4f62-98e1-372e02bd793b")
    @Override
    public void changeProperty(final ModelElement elt, final int row, final String value) {
        if(row == 1){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_ISPREEMPTIBLE, value);
        }
        else if(row == 2){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDPOLICY, value);
        }
        else if(row == 3){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_OTHERSCHEDPOLICY, value);
        }
        else if(row == 4){
            ModelUtils.addStringValue(elt, MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDULE, value);
        }
        else if(row == 5){
            ...
            ModelUtils.manageMultipleToOneLink(elt,
                    ...
                    possibleTagTypeName,
                    MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_PROCESSINGUNITS,
                    value
            );
        }
        else if(row == 6){
        ...
        //                    MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_HOST, 
                    value
            );
        }
        else if(row == 7){
            ...
            ModelUtils.manageMultipleToOneLink(elt,
                    ...
                    possibleTagTypeName,
                    MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_PROTECTEDSHAREDRESOURCES,
                    value
            );
        }
        else if(row == 8){
            ...
            ModelUtils.manageMultipleToOneLink(elt,
                    ...
                    possibleTagTypeName,
                    MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDULABLERESOURCES,
                    value
            );
        }
    }

    @objid ("9a11fc31-26db-48cd-8d12-5dfd0fbea7ad")
    @Override
    public void update(final ModelElement elt, final IModulePropertyTable table) {
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_ISPREEMPTIBLE),ModelUtils.hasTaggedValue(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_ISPREEMPTIBLE, elt));
        
        String[] types = MARTEEnumerationUtils.getSchedPolicyKind();
        String value_schedPolicy = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDPOLICY, elt);
        if(!(MARTEEnumerationUtils.isSchedPolicyKind(value_schedPolicy))){
             value_schedPolicy = "FixedPriority";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDPOLICY),value_schedPolicy, types);
        
        
        String value_otherSchedPolicy = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_OTHERSCHEDPOLICY, elt);
        if(value_otherSchedPolicy.equals("")){
            value_otherSchedPolicy = "";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_OTHERSCHEDPOLICY),value_otherSchedPolicy);
        
        
        String value_schedule = ModelUtils.getTaggedValue(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDULE, elt);
        if(value_schedule.equals("")){
            value_schedule = "";
        }
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDULE),value_schedule);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_PROCESSINGUNITS), value_processingUnits, tab_processingUnits);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_HOST), value_host, tab_host);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_PROTECTEDSHAREDRESOURCES), value_protectedSharedRsources, tab_protectedSharedRsources);
        ...
        table.addProperty(MARTEResourceManager.getPropertyName(MARTEDesignerTagTypes.SCHEDULER_LIFELINE_SCHEDULER_LIFELINE_SCHEDULABLERESOURCES), value_schedulableResources, tab_schedulableResources);
    }
