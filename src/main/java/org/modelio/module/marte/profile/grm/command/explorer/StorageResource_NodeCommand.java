...
public class StorageResource_NodeCommand extends DefaultModuleCommandHandler {
    @Override
    ...
    public void actionPerformed(List<MObject> selected_element, IModule module) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("StorageResource_NodeCommand")){
        
        
            ModelElement parent = (ModelElement)selected_element.get(0);        
            StorageResource_Node proxy = new StorageResource_Node();
