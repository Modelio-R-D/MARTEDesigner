...
public class SwTimerResource_InstanceCommand extends DefaultModuleCommandHandler {
    @Override
    ...
    public void actionPerformed(List<MObject> selected_element, IModule module) {
        try(ITransaction tr = MARTEModule.getInstance().getModuleContext().getModelingSession().createTransaction("SwTimerResource_InstanceCommand")){
        
        
            ModelElement parent = (ModelElement)selected_element.get(0);        
            SwTimerResource_Instance proxy = new SwTimerResource_Instance();
